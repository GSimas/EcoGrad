...
for(const file of [...readdirSync(tests).filter(n=>n.endsWith('.test.js')).map(n=>tests+n),...['collection-metadata.test.mjs','collection-shards.test.mjs','collection-batches.test.mjs'].map(n=>fileURLToPath(new URL('../tests/'+n,import.meta.url)))]){
