...
const TODOS: { id: string; titulo: string; descricao: string; orientacao: string; rota: Rota; buscaTipo?: TipoBusca }[] = [
  ...
  { id: 'estrutura', titulo: 'Entender a estrutura da rede', descricao: 'Situe temas, pessoas e conceitos no grafo em Exploração Global.', orientacao: 'Prefira coleções com palavras-chave e macrotemas preenchidos. Os índices descrevem a posição na rede deste recorte; não medem qualidade nem impacto.', rota: 'exploracao' },
