...
export function VisaoEntidade({ tipo, docs, termo }: { tipo: TipoBusca; docs: readonly Documento[]; termo: string }) {
  ...
  return <section className="space-y-5" aria-label={`Trabalhos e relações de ${termo}`}>
    ...
    <div className="grid gap-4 lg:grid-cols-2">
      <Relacoes docs={docs} tipo={tipo === 'Orientador' || tipo === 'Co-orientador' ? 'Autor' : 'Orientador'} titulo={tipo === 'Orientador' || tipo === 'Co-orientador' ? 'Autores dos trabalhos associados' : 'Orientadores dos trabalhos associados'} />
