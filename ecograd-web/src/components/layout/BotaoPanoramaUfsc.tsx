...
export function BotaoPanoramaUfsc({ compacto = false, className, desabilitado = false }: {
  ...
  return <Janela titulo="Panorama UFSC" descricao="O acervo inteiro em números e os programas de pós-graduação reconhecidos pela CAPES — independentes das coleções da sua análise." larga
