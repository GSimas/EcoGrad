...
const PASSOS: Passo[] = [
  { icone: LayoutDashboard, titulo: 'Comece por uma pergunta e escolha o recorte', corpo: <><p><strong>Acompanhe um caso ao longo dos seis passos:</strong> Ana quer descobrir quais temas aparecem na produção do Programa de Pós-Graduação em Engenharia Mecânica, como esses temas mudaram e quais trabalhos e pesquisadores estão ligados a eles. Na apresentação, ela escolhe <strong>Conhecer a produção das coleções</strong> para transformar essa pergunta em um recorte analisável.</p><p>Na seleção, Ana busca “Engenharia Mecânica”. Como o catálogo pode mostrar a coleção principal, outra coleção com identificador próprio e uma modalidade profissional, ela não escolhe apenas pela semelhança do nome. Abre <strong>Ver cobertura e fontes</strong>, compara identificador, modalidade, quantidade de registros, período e campos preenchidos e então marca exatamente <strong>Programa de Pós-Graduação em Engenharia Mecânica</strong>.</p><p>Antes de carregar, ela revisa o nome e o volume estimado. Uma coleção vazia indicaria somente ausência de registros no recorte local; os anos reproduzem os metadados disponíveis e não informam a data da coleta. Com o recorte conferido, Ana carrega a coleção e segue para o Dashboard.</p></> },
