...
2. **Seleção de coleções** — escolha dos PPGs e cursos, com o Panorama CAPES
   sempre visível.
3. **Análise** — Dashboard, Motor de Busca, Exploração Global, Foresight e Memética. O UFSCão, consultor de IA, fica em um botão
